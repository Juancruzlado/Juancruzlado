...
I love challenges & every learning oportunity is appreciated!
...
My strongest attribute in programming is the backend in symfony projects, linux docker env for development, specifically when desigining testable services which interact with the model of the application to produce relevant data to be showcased in the CRUD part of the app
